<script lang="ts">
  ...
  $: themeIcon = (
    { dark: 'moon', light: 'sun', system: 'deviceDesktop' } as Record<Theme, iconType>
  )[$theme];
</script>
...
>
  ...
  <DropdownMenu placement="bottom-end" let:close class="!p-0">
    <Button variant="rounded" slot="trigger">
      <Icon
        name="userCircle"
